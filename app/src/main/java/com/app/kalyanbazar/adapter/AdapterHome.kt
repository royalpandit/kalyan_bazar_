...
if (list[position].openPanaResult.equals("")&&list[position].closePanaResult.equals("")){
    ...
    holder.binding.eventNumber.text = list[position].openPanaResult+""+list[position].closePanaResult
}
       // holder.binding.eventNumber.text = list[position].marketCode

        holder.binding.openingTime.text = Helper.dateFormateampm(list[position].marketOpeningTime.toString())
        holder.binding.closingTime.text = Helper.dateFormateampm(list[position].marketClosingTime.toString())
...
/*
            Log.e("chart","==>>>"+ list[position].marketName)

            activity.intent.putExtra("market_name", list[position].marketName)
            activity.intent.putExtra("market_id", list[position].id)*/
